📈 Nivesh Nagar A full-stack paper trading simulator inspired by Zerodha Kite.
...
Auth: JWT, bcrypt
📂 Project Structure nivesh-nagar/ ├── frontend/ # Marketing website (React) ├── dashboard/ # Trading dashboard (React) └── backend/ # REST API (Node + Express)
